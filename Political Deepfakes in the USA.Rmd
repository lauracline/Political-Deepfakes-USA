...
Figure 1 demonstrates the distribution of Facebook usage among experiment participants. The data shows that the majority of respondents use Facebook "several times a day", followed by "about once a day" and "less often" (Figure \@ref(fig:go)).
...
![Data Sheets 1](appendix_materials/data_sheets1.png)

![Data Sheets 2](appendix_materials/data_sheets2.png)

![Data Sheets 3](appendix_materials/data_sheets3.png)

![Data Sheets 4](appendix_materials/data_sheets4.png)

![Principal Experiment Linear Model 1](appendix_materials/principal_experiment_lm1.png)

![Principal Experiment Linear Model 2](appendix_materials/principal_experiment_lm2.png)

![Principal Experiment Linear Model 3](appendix_materials/principal_experiment_lm3.png)
